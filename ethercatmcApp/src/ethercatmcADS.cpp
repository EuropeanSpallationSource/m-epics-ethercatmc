...
asynStatus
ethercatmcController::writeReadBinaryFL(asynUser *pasynUser,
                                        const char *outdata,
                                        size_t outlen,
                                        char *indata,
                                        size_t inlen,
                                        ...
                                        int lineNo)
{
  ...
  *pnread = 0;
  ...
  if (nread2) {
    ethercatmchexdump(pasynUser, tracelevel, "IN2 ",
                      indata, nread2 + part_1_len);
  }
                                                     ...
                                                     int lineNo)
{
  ...
  *pnread = 0;
  ...
  status = writeReadBinaryFL(pasynUser,
