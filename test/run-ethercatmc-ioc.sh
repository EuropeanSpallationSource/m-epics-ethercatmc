...
generate_st_cmd_e3() {
  > $stcmddst &&
    cat >>$stcmddst <<-EOF &&
#This file had been autogenerated by run-ethercatmc-ioc.sh - edit with care
require ethercatmc
dbLoadDatabase("$(ethercatmc_DIR)/dbd/ethercatmc.dbd")
ethercatmc_registerRecordDeviceDriver pdbbase
...
(
  ...
  case $EPICS_EEE_E3 in
    classic)
      ...
      ( cd $IOCDIR_E3 && generate_st_cmd_e3)
