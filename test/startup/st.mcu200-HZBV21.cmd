...
epicsEnvSet("PREFIX",        "$(SM_PREFIX=HZB-V21:)")
epicsEnvSet("P",             "$(SM_PREFIX=HZB-V21:)")
...
#########################
epicsEnvSet("AXISCONFIG",    "adsPort=852;stepSize=1.0;HomProc=0")
epicsEnvSet("MOTOR_NAME",    "MC-SLT-01:SltH-Center")
epicsEnvSet("AXIS_NO",       "1")
epicsEnvSet("DESC",          "H Center")
< EthercatMCAxis.iocsh

epicsEnvSet("AXISCONFIG",    "adsPort=852;powerOffDelay=2.0;stepSize=1.0;HomProc=0")
...
epicsEnvSet("AXISCONFIG",    "adsPort=852;stepSize=1.0;HomProc=1")
epicsEnvSet("MOTOR_NAME",    "MC-MCU-01:m9")
epicsEnvSet("AXIS_NO",       "9")
epicsEnvSet("DESC",          "Height 1")
< EthercatMCAxis.iocsh

epicsEnvSet("AXISCONFIG",    "adsPort=852;stepSize=1.0;HomProc=15")
...
epicsEnvSet("AXISCONFIG",    "adsPort=852;stepSize=1.0;HomProc=1;HomPos=-1.4")
