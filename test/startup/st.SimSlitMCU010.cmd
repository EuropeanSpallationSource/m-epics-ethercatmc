...
epicsEnvSet("AXISCONFIG",    "stepSize=1.0;cfgFile=./SimAxis-48-1.cfg;encoder=ADSPORT=501/.ADR.16#3040010,16#80000049,2,2;HomProc=1;HomPos=0.0")

< EthercatMCController.cmd
< EthercatMCAxis.cmd
< EthercatMCAxisdebug.cmd

epicsEnvSet("AXISCONFIG",    "stepSize=1.0;cfgFile=./SimAxis-48-1.cfg;encoder=ADSPORT=501/.ADR.16#3040010,16#8000004F,2,2;HomProc=2;HomPos=172")
