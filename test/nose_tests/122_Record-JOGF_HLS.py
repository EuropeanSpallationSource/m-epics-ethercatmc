...
class Test(unittest.TestCase):
    ...
    def test_TC_1222(self):
        ...
        if (self.msta & self.lib.MSTA_BIT_HOMED):
            ...
            self.lib.movePosition(motor, tc_no, self.per70_UserPosition, self.moving_velocity, self.acceleration)
            ...
            self.assertEqual(0, mstaE & self.lib.MSTA_BIT_MINUS_LS,   'Minus hard limit switch not active')
            self.assertNotEqual(0, mstaE & self.lib.MSTA_BIT_PLUS_LS, 'Plus hard limit switch active')
